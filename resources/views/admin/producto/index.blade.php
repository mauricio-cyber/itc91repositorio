                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'Localizacion'">{{ trans('admin.producto.columns.Localizacion') }}</th>
                                        <th is='sortable' :column="'Precio'">{{ trans('admin.producto.columns.Precio') }}</th>
                                        <th is='sortable' :column="'Caducidad'">{{ trans('admin.producto.columns.Caducidad') }}</th>
