...
class FillPermissionsForMasproducto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMasproducto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.masproducto',
            'admin.masproducto.index',
            'admin.masproducto.create',
            'admin.masproducto.show',
            'admin.masproducto.edit',
            'admin.masproducto.delete',
            'admin.masproducto.bulk-delete',
        ]);
